...
import Img2 from "../assets/Posina_2.jpg";

export default function Contatti() {


    return (
        <div className="flex flex-col md:flex-row items-center justify-center z-50 min-h-screen fixed inset-0 bg-white before:content-[''] before:absolute before:inset-0 before:bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgba(6,182,212,0.25),transparent_70%)] after:content-[''] after:absolute after:inset-0 after:bg-[radial-gradient(ellipse_80%_60%_at_50%_100%,rgba(6,182,212,0.25),transparent_70%)]">
            <div className="md:w-1/2 p-10 lg:px-20">
                ...
                <span className="block text-md md:text-lg ld:text-2xl text-black leading-7 lg:leading-10 font-thin -mt-1">
            ...
            <div className="flex-shrink group relative w-full h-[350px] max-w-xs md:w-[450px] md:h-[450px] md:max-w-md bg-gray-100/30  rounded-[32px] p-[3px] shadow-[0_70px_30px_-50px_rgba(96,75,74,0.19)] transition-all duration-500 ease-in-out hover:rounded-tl-[55px]">
                {/* Profile Picture */}
                ...
                <div className="absolute bottom-[3px] left-[3px] right-[3px] bg-gray-100 top-[80%] rounded-[29px] z-[2] shadow-[0_5px_5px_0_rgba(96,75,74,0.19)_inset] overflow-hidden transition-all duration-500 cubic-bezier(0.645,0.045,0.355,1) group-hover:top-[20%] group-hover:rounded-[80px_29px_29px_29px] group-hover:delay-200">
                    {/* Content */}
                    <div className="relative w-full h-full rounded-xl overflow-hidden mb-4 hidden group-hover:block">
                        <img
                            src={Img2}
                            alt="David Babic"
                        ...
                        {/*<div className="absolute inset-0 flex flex-col items-center justify-center bg-black/40">
                            <h3 className="font-medium text-4xl items-center leading-12 text-white">
                                Photoplaces
                                <br />
                    ...
                    <div className="absolute bottom-4 left-6 right-6 flex items-center justify-between">
                        ...
                        <div className="flex items-center justify-center gap-3 md:gap-5">
                            <span className="flex items-center justify-center rounded-full border  bg-white/30 backdrop-blur-md hover:bg-gray-300 duration-300 transition-colors size-9 size-10">
