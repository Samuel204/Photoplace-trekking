...
export default function CardEscursioniDetail({
    ...
    // Funzione per determinare il colore del badge di difficoltà
    ...
    return (
        <div className="overflow-hidden rounded-lg bg-white hover:shadow-lg transition-shadow group">
            <div className="aspect-video bg-gradient-to-br from-emerald-200 to-sky-200 relative overflow-hidden">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24"
                         ...
                         strokeLinejoin="round" className="w-12 h-12 text-white/80">
            ...
            <div className="p-6">
                ...
                {/* Informazioni su distanza e dislivello */}
                {(distance || elevation) && (
                ...
                <div className={`inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 ${getDifficultyColor(difficulty)}`}>
                    {difficulty}
                </div>
            </div>
        </div>
